<?php
/* Smarty version 3.1.39, created on 2022-01-17 22:29:13
  from 'module:psimagesliderviewstemplat' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61e5dfa921a688_85579466',
...
function content_61e5dfa921a688_85579466 (Smarty_Internal_Template $_smarty_tpl) {
?>
  <div id="carousel" data-ride="carousel" class="carousel slide" data-interval="5000" data-wrap="true" data-pause="hover" data-touch="true">
    ...
    <ul class="carousel-inner" role="listbox" aria-label="Carousel container">
          ...
          <a href="https://presta.bielinski.dev/pl/2-strona-glowna">
            <figure>
              <img src="http://localhost:8080/modules/ps_imageslider/images/sample-1.jpg" alt="Otrzymaj 35% rabatu" loading="lazy" width="1110" height="340">
...
<p>Śpiesz się! Oferta ograniczona czasowo.</p></div>
          ...
          <a href="https://presta.bielinski.dev/pl/2-strona-glowna">
            <figure>
              <img src="http://localhost:8080/modules/ps_imageslider/images/sample-2.jpg" alt="Tylko w Światłeks" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
...
<p>Lampy lepsze jakościowo oraz prawie tańsze niż w znanym szwedzkim sklepie!</p></div>
          ...
          <a href="https://presta.bielinski.dev/pl/2-strona-glowna">
            <figure>
              <img src="http://localhost:8080/modules/ps_imageslider/images/sample-3.jpg" alt="JASNOŚĆ" loading="lazy" width="1110" height="340">
                              <figcaption class="caption">
